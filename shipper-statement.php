                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <ol class="breadcrumb float-right">
                                ...
                                <li class="breadcrumb-item active">Shipper Statement</li>
                            </ol>
                            <h4 class="page-title">Shipper Statement</h4>
                        </div>
                        <!-- End page title box -->
                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                        ...
                                        <tbody id="table_body">
                                            <?php 
                                            $bill_payment = DB::table('shippers')
                                            ->get(); 
                                            $count = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $pay->shipper_code; ?></td>
                                                <td><?php echo $pay->name; ?></td>
                                                <td><?php echo $pay->address; ?></td>
                                                <td><a href="statements.php?shipper_code=<?php echo $pay->shipper_code; ?>" class="btn btn-info">Statement</a></td>
                                            </tr>
                                            <?php $count++; } ?>
                                        </tbody>
                                    </table>
